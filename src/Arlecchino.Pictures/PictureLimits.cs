...
/// </summary>
/// <param name="MostPixels">How many pixels may be held at once, refusing anything larger.</param>
/// <param name="EnoughPixels">
...
/// </param>
public readonly record struct PictureLimits(int MostPixels, int EnoughPixels)
{
