...
/// <summary>
/// Editing a line of text: where the caret goes and what each edit does to it, kept apart from the fields so
/// every one of them behaves alike. The validation message is the router's to clear, not this one's.
/// </summary>
