...
/// <summary>
/// Turns a route into a view by asking each registered factory in turn. Each screen is built inside its own
/// container scope, so a scoped service is released when the screen goes away.
/// </summary>
