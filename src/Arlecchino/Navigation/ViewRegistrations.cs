...
{
    private readonly Dictionary<string, Func<IServiceProvider, IView>> _factories = new(StringComparer.Ordinal);
    ...
    public void Add(string name, Func<IServiceProvider, IView> factory)
    {
    ...
    public bool TryGet(string name, [NotNullWhen(true)] out Func<IServiceProvider, IView>? factory)
    {
