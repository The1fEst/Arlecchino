...
/// <summary>
/// A window onto content taller than the space it has: it draws the content shifted up by the offset, clips
/// it, and answers the movement keys and the wheel. The content is drawn by a delegate rather than owned.
/// </summary>
