...
/// <summary>
/// A block of text to read: wrapped to the width it is given, scrolled with the movement keys and the wheel.
/// It is re-wrapped whenever the width changes, so resizing the terminal reflows it.
/// </summary>
