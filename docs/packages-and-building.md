...
The version is `1.0.1` for the whole repository. Because it does not change between builds, NuGet may
...
`Arlecchino.1.0.1.nupkg` carries `lib/net8.0/Arlecchino.dll` and `lib/net10.0/Arlecchino.dll`, the
